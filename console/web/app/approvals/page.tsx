...
import type { JudgmentProposalRecord, ProposalRecord } from "../../lib/types";
...
function Approvals() {
  ...
  return (
    <>
      ...
      <div className="section-title">Decided ({decided.length + decidedJudgments.length})</div>
      <div className="panel">
        ...
        {!loading && decided.length === 0 && decidedJudgments.length === 0 && (
