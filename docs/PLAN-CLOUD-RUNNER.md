...
- [ ] **T0-4. The failing tests, first. (#165)** Before any runner code, commit the vacuous-pass cases the evaluator must refuse, under `it.fails`, each asserting *no `evidenced` bundle*:
