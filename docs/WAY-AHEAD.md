...
1. **P1–P4**, chosen by the owner 2026-09-17 ahead of R2/SDR, after the field went from empty to crowded in four weeks (upstream published rules 2026.09.13.02; Prowler merged CR26 KSI frameworks for AWS/Azure/GCP; `RootCawsLLC/ksi-harness` appeared as a direct OSS rival). Opened as issues #210–#213 under the milestone *P1–P4 — the crowded-field response*; there is no separate plan document, this item is the plan. **P1 (#210, the re-pin) landed 2026-09-18** — see §8. Next: **P2 (#211)**, the rejection linter from community #167, researched in `docs/RESEARCH-REJECTION-LINTER.md` — P2-0 and P2-3 are the shippable core; then **P3 (#212)**, ingesting Prowler's 20x KSI output; then **P4 (#213)**, a trust-center fetchability probe.
