...
export async function loadAwsActionAllowlist(path) {
 ...
 */
export function awsActionOf(segment) {
...
export function classifyAwsAction(list, cli) {
    ...
    if (refused)
        return { kind: "refused", entry: refused };
    return { kind: "unknown" };
}
...
export function isPlainlyRead(entry) {
