...
export async function loadAwsStepLabels(path: string): Promise<AwsStepLabels> {
...
export function stepLabels(recipeId: string, steps: ReadonlyArray<readonly string[]>, table?: AwsStepLabels): string[] {
